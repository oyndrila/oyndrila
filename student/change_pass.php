...
//        $count = 0 ;
            $query = "SELECT password FROM student_registration WHERE username = '$_SESSION[username]' ";
        ...
        if( $old_pass ==  $dec_pass)
        {
                ...
                $query1= "UPDATE student_registration set password = '$result1' WHERE username = '$_SESSION[username]' ";
