...
{  
    $sql_u = "SELECT * FROM staff_registration WHERE username='$_POST[username]'";
    ...
    $query =" INSERT INTO `staff_registration`(`id`, `first_name`, `last_name`, `username`, `password`, `email`, `contact`, `status`) VALUES ('','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$enc_pass','$_POST[email]','$_POST[contact]','no')";
